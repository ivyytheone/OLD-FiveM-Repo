...
Config.Strings = {
	ExitVehicle = "Kliv ur ditt fordon för att påbörja tankningen",
	EToRefuel = "Tryck ~g~E ~w~för att påbörja tankningen",
	JerryCanEmpty = "Bensindunken är tom",
	FullTank = "Tanken är full.",
	PurchaseJerryCan = "Tryck ~g~E ~w~för att köpa en bensindunk för ~g~" .. Config.JerryCanCost .. " SEK",
	CancelFuelingPump = "Tryck ~g~E ~w~för att avbryta tankningen",
	CancelFuelingJerryCan = "Tryck ~g~E ~w~för att avbryta tankningen",
	NotEnoughCash = "Du har inte tillräckligt med pengar...",
	RefillJerryCan = "Tryck ~g~E ~w~för att fylla på bensindunken för ",
	NotEnoughCashJerryCan = "Du har inte tillräckligt med pengar...",
