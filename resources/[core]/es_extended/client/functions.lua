...
ESX.ShowNotification = function(Message, Type, timeout) 
    exports.eyrp_notify:LoadNotification(Message, Type, timeout)
end   

ESX.DrawScriptMarker = function(markerData)
...
ESX.Game.Utils.ShowHelpText = function(coords, msg)
    if not msg then
        msg = "Inget värde";
    end
    
    AddTextEntry('ESX:ShowHelpText', msg)
    SetFloatingHelpTextWorldPosition(1, coords)
    SetFloatingHelpTextStyle(1, 1, 2, -1, 3, 0)
    BeginTextCommandDisplayHelp('ESX:ShowHelpText')
