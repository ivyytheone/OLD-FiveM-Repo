...
Citizen.CreateThread(function() 
    ...
    while true do  
        ...
        if Action.Dressing == 1 then   
            ...
            Utils.Draw3DText(GetOffsetFromEntityInWorldCoords(pedPlayer, 0.0, 0.0, 1.0), "[~g~G~s~] - Dina kläder") 
            Utils.Draw3DText(GetOffsetFromEntityInWorldCoords(pedPlayer, 0.0, 0.0, 0.9), "[~g~Q~s~] - Omklädningsrum") 
