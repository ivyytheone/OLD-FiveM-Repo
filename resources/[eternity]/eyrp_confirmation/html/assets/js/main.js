        ...
        $.confirm({
            ...
            buttons: {
                YES: {
                    text: confirmText,
                    action: function () {
                        PushPipe("eyrp_confirmation:eventHandler", {
                            ["response"]: "nui_fix"
                        })
...
/*
    Animations:
    right, left, bottom, top, rotate, none, opacity, scale, zoom, scaleY, scaleX, rotateY, rotateYR (reverse), rotateX, rotateXR (reverse)
