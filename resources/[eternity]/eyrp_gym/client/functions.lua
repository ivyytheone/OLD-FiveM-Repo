...
StartWorkout = function(workoutInfo, workoutType)
    ...
    while doingWorkout do
        ...
        Draw3DText({
            Coords = { ["x"] = workoutInfo["Pos"]["x"], ["y"] = workoutInfo["Pos"]["y"], ["z"] = workoutInfo["Pos"]["z"] + 0.500 }, 
            Text = "Gymmar... ~g~" .. math.floor(percent) .. "%"
        })
        ...
        if randomDamage == 2 then
            if doingRest then
                if percent > 50 then
                    ...
                    exports["eyrp_skillsystem"]:RemoveSkillLevel("Gym", tonumber(skill))
    ...
    exports["eyrp_skillsystem"]:AddSkillLevel("Stamina", tonumber(gymSkill))
    exports["eyrp_skillsystem"]:AddSkillLevel("Strength", tonumber(strengthSkill))
...
HandleSkill = function()
    local gymSkill = exports["eyrp_skillsystem"]:GetSkillLevel("Stamina")
    local strengthSkill = exports["eyrp_skillsystem"]:GetSkillLevel("Strength")
...
LoadBlip = function()
    ...
    SetBlipDisplay(WorkoutBlip, 4)
    SetBlipColour(WorkoutBlip, 0)
    SetBlipAsShortRange(WorkoutBlip, true)
