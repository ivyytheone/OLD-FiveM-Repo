...
AddTextEntry(controllerMessageLoweredCar, "Tryck ~INPUT_CONTEXT~ för att ~y~höja ~w~flaket.~n~Tryck ~INPUT_DETONATE~ för att ~r~lösa ~w~fordonet.")
AddTextEntry(controllerMessageLoweredNoCar, "Tryck~INPUT_CONTEXT~ för att ~y~höja~w~flaket.~n~Tryck ~INPUT_DETONATE~ för att ~g~lossa~w~ på fordonet.")
AddTextEntry(controllerMessageRaised, "Tryck~INPUT_CONTEXT~ för att ~y~sänka ~w~fordonet.")
